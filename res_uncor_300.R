...
load(file = "source_data/uncor_300.rda")
...
res_pocock_2 <- lapply(X = uncor_300,
...
res_pocock_4 <- lapply(X = uncor_300,
                       FUN = function(data) rando_pocock_strat(data = data,
...
save(res_MSB, file = "res_uncor_300/res_MSB_uncor_300.rda")
save(res_blocks, file = "res_uncor_300/res_blocks_uncor_300.rda")
save(res_pocock_2, file = "res_uncor_300/res_pocock_2_uncor_300.rda")
save(res_pocock_4, file = "res_uncor_300/res_pocock_4_uncor_300.rda")