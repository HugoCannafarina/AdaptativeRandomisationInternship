...
load(file = "res_cor_820/res_blocks_cor_820.rda")
load(file = "res_cor_820/res_MSB_cor_820.rda")
load(file = "res_cor_820/res_pocock_2_cor_820.rda")
load(file = "res_cor_820/res_pocock_4_cor_820.rda")
