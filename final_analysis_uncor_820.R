...
#########################################
### Uncorrelated datasets of size 820 ###
#########################################

load(file = "res_uncor_820/res_blocks_uncor_820.rda")
load(file = "res_uncor_820/res_MSB_uncor_820.rda")
load(file = "res_uncor_820/res_pocock_2_uncor_820.rda")
load(file = "res_uncor_820/res_pocock_4_uncor_820.rda")
