...
load(file = "source_data/cor_300.rda")
...
save(res_MSB, file = "res_cor_300/res_MSB_cor_300.rda")
save(res_blocks, file = "res_cor_300/res_blocks_cor_300.rda")
save(res_pocock_2, file = "res_cor_300/res_pocock_2_cor_300.rda")
save(res_pocock_4, file = "res_cor_300/res_pocock_4_cor_300.rda")