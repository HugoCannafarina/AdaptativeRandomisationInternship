...
load(file = "source_data/cor_820.rda")
...
save(res_MSB, file = "res_cor_820/res_MSB_cor_820.rda")
save(res_blocks, file = "res_cor_820/res_blocks_cor_820.rda")
save(res_pocock_2, file = "res_cor_820/res_pocock_2_cor_820.rda")
save(res_pocock_4, file = "res_cor_820/res_pocock_4_cor_820.rda")